                        ...
                        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                <td colspan="2" class="centerAlign">
                                    ...
                                    <input type="reset" value="Clear" class="groovybutton" onclick="javascript:document.location.href='${pageContext.request.contextPath}/admin/managePublishers'" />
                                </td>
                            </tr>
                        </table>
                    </td>
            ...
            <table class="data" width="100%">
                ...
                <c:forEach items="${publisherList}" var="publisher">
                    <tr>
                        ...
                        <td><a href="${pageContext.request.contextPath}/admin/deletePublisher/${publisher.publisherNo}"><img title="Click to delete" src="${pageContext.request.contextPath}/images/delete.jpg"/></a></td>
                        <td><a href="${pageContext.request.contextPath}/admin/editPublisher/${publisher.publisherNo}"><img title="Click to edit" src="${pageContext.request.contextPath}/images/edit.jpg"/></a></td>
                    </tr>
                </c:forEach>
            </table>
        </c:if>
