            ...
            <table border="0" width="100%" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td align="left" class="topAlign">
                        <img src="<%=request.getContextPath()%>/admin/downloadBookPhotograph/${bookList.bookNo}" height="150px" width="150px"/>
                    </td>
                    <td align="center">
                        <sec:authorize access="isAuthenticated()">
                            <a href="<%=request.getContextPath()%>/addToCart/<sec:authentication property='principal.username' />/${bookList.bookNo}">
                                <img src="<%=request.getContextPath()%>/images/addToCart.jpg" width="74px" height="74px" class="imagePointer" border="0"/>
                            </a>&nbsp;
                        </sec:authorize>
                    </td>
                </tr>
                            ...
                            <table border="0" cellspacing="2" cellpadding="0" width="100%" style="border: 1px dashed #0099ff;">
                                ...
                                <tr>
                                    <td valign="top" colspan="2" class="content" width="50%" align="center" style="border-right: 1px dashed #0099ff;">
                                        <a href="${pageContext.request.contextPath}/admin/downloadBookSampleChapter/${bookList.bookNo}">Sample</a>
                                    </td>
                                    <td valign="top" class="content" width="50%" align="center">
                                        <a href="${pageContext.request.contextPath}/admin/downloadBookTOC/${bookList.bookNo}">TOC</a>
                                    </td>
                                </tr>
                            </table>
                        </sec:authorize>
