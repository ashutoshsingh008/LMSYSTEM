                        ...
                        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                <td colspan="2" class="centerAlign">
                                    ...
                                    <input type="reset" value="Clear" class="groovybutton" onclick="javascript:document.location.href='${pageContext.request.contextPath}/admin/manageAuthors'" />
                                </td>
                            </tr>
                        </table>
                    </td>
            ...
            <table class="data" width="100%">
                ...
                <c:forEach items="${authorList}" var="author">
                    <tr>
                        ...
                        <td><a href="${pageContext.request.contextPath}/admin/downloadAuthorPhotograph/${author.authorNo}"><img src="${pageContext.request.contextPath}/admin/downloadAuthorPhotograph/${author.authorNo}" width="150px"/></a></td>
                        <td><a href="${pageContext.request.contextPath}/admin/deleteAuthor/${author.authorNo}"><img title="Click to delete" src="${pageContext.request.contextPath}/images/delete.jpg"/></a></td>
                        <td><a href="${pageContext.request.contextPath}/admin/editAuthor/${author.authorNo}"><img title="Click to edit" src="${pageContext.request.contextPath}/images/edit.jpg"/></a></td>
                    </tr>
                </c:forEach>
            </table>
        </c:if>
